...
> **Note:** history up to and including the pnpm/Changesets migration lives here. From this point on, each package's release notes live in its own `CHANGELOG.md` under `packages/*/CHANGELOG.md`, generated by [Changesets](https://github.com/changesets/changesets).
