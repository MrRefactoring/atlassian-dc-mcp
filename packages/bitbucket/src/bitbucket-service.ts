import { z } from 'zod';
import { AuthenticationService, BuildsAndDeploymentsService, DeprecatedService, OpenAPI, ProjectService, PullRequestsService, RepositoryService, SecurityService } from './bitbucket-client/index.js';
