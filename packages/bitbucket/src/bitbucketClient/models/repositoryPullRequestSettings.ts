...
export const RepositoryPullRequestSettingsSchema = z.looseObject({
...
export type RepositoryPullRequestSettings = z.infer<typeof RepositoryPullRequestSettingsSchema>;
