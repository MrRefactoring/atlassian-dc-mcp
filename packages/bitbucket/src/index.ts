...
server.tool(
  ...
  async ({ projectKey, filter, start, limit }) => {
    const result = await bitbucketService.getProjectPermissions(projectKey, filter, start, limit);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, name, permission }) => {
    const result = await bitbucketService.setProjectUserPermission(projectKey, name, permission);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, name, permission }) => {
    const result = await bitbucketService.setProjectGroupPermission(projectKey, name, permission);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, user, group }) => {
    const result = await bitbucketService.revokeProjectPermission(projectKey, user, group);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, repositorySlug, filter, start, limit }) => {
    const result = await bitbucketService.getRepoPermissions(projectKey, repositorySlug, filter, start, limit);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, repositorySlug, name, permission }) => {
    const result = await bitbucketService.setRepoUserPermission(projectKey, repositorySlug, name, permission);
    return formatToolResponse(result);
  }
);
...
server.tool(
  ...
  async ({ projectKey, repositorySlug, name, permission }) => {
    const result = await bitbucketService.setRepoGroupPermission(projectKey, repositorySlug, name, permission);
    return formatToolResponse(result);
  }
);
...
server.registerResource(
  ...
  async (uri, { projectKey, repositorySlug }) => {
    const result = await bitbucketService.getRepository(firstValue(projectKey), firstValue(repositorySlug));
    return {
      contents: [
        {
          uri: uri.href,
