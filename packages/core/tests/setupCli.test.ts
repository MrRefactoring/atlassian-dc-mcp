...
import { HomeFileSource } from '../src/config/sources/homeFile.js';
import { MacosKeychainSource, type KeychainDeps } from '../src/config/sources/macosKeychain.js';
import { ProcessEnvSource } from '../src/config/sources/processEnv.js';
import {
  runSetup,
